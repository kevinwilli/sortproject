...
public class Car {
    ...
    public Car() {
        ...
        String[] makes = {"Toyota", "Honda", "Ford", "Chevrolet", "BMW", "Mercedes-Benz", "Nissan", "Volkswagen", "Tesla", "Audi"};
        String[] models = {"Corolla", "Civic", "F-150", "Silverado", "3 Series", "E-Class", "Altima", "Jetta", "Model S", "A4"};
    ...
    //getters for the car
    //we don't need setters because we don't want to change the attributes of the car
